...
(cl:defmethod cl:initialize-instance :after ((m <theta_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'theta_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localize-msg:<theta_stamped> is deprecated: use localize-msg:theta_stamped instead.")))
...
(cl:defmethod data-val ((m <theta_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localize-msg:data-val is deprecated.  Use localize-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'detect-val :lambda-list '(m))
(cl:defmethod detect-val ((m <theta_stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localize-msg:detect-val is deprecated.  Use localize-msg:detect instead.")
  (detect m))
